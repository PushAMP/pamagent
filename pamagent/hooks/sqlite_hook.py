...
class CursorWrapper(DBAPI2CursorWrapper):
    def executescript(self, sql_script):
        ...
        with DatabaseTrace(transaction, sql_script, self._pm_dbapi2_module, self._pm_connect_params):
...
class ConnectionWrapper(DBAPI2ConnectionWrapper):
    ...
    def execute(self, sql, parameters=DEFAULT):
        ...
        if parameters is not DEFAULT:
            with DatabaseTrace(transaction, sql, self._pm_dbapi2_module, self._pm_connect_params, None, parameters):
    ...
    def executemany(self, sql, seq_of_parameters):
        transaction = current_transaction()
        with DatabaseTrace(transaction, sql, self._pm_dbapi2_module, self._pm_connect_params, None,
